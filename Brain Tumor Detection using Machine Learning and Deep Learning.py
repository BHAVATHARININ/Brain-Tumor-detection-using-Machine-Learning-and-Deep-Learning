...
path = os.listdir('C:/Users/BHAVATHARINI/OneDrive/Desktop/AML PROJECT/CNN/Training/')
...
X = []
for cls in classes:
    pth = 'C:/Users/BHAVATHARINI/OneDrive/Desktop/AML PROJECT/CNN/Training/'+cls
...
p = os.listdir('C:/Users/BHAVATHARINI/OneDrive/Desktop/AML PROJECT/CNN/Testing/')
c=1
for i in os.listdir('C:/Users/BHAVATHARINI/OneDrive/Desktop/AML PROJECT/CNN/Testing/no_tumor/')[:9]:
    plt.subplot(3,3,c)
    
    img = cv2.imread('C:/Users/BHAVATHARINI/OneDrive/Desktop/AML PROJECT/CNN/Testing/no_tumor/'+i,0)
...
p = os.listdir('C:/Users/BHAVATHARINI/OneDrive/Desktop/AML PROJECT/CNN/Testing/')
c=1
for i in os.listdir('C:/Users/BHAVATHARINI/OneDrive/Desktop/AML PROJECT/CNN/Testing/pituitary_tumor/')[:16]:
    plt.subplot(4,4,c)
    
    img = cv2.imread('C:/Users/BHAVATHARINI/OneDrive/Desktop/AML PROJECT/CNN/Testing/pituitary_tumor/'+i,0)
    img1 = cv2.resize(img, (200,200))
    img1 = img1.reshape(1,-1)/255
    p = sv.predict(img1)
    plt.title(dec[p[0]])
